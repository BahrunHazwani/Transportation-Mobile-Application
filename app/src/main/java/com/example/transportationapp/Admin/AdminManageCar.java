...
public class AdminManageCar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_manage_car);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        {
            startActivity(new Intent(AdminManageCar.this, AdminManageCar.class));
            finish();
        }
    }
    ...
    private void deleteThisCar() {
        carsRef.removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Intent intent = new Intent(AdminManageCar.this, AdminHome.class);
                startActivity(intent);
                finish();

                Toast.makeText(AdminManageCar.this, "The Car is deleted successfully.", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            carsRef.updateChildren(carMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(AdminManageCar.this, "Changes applied successfully.", Toast.LENGTH_SHORT).show();
    ...
    private void uploadImage() {
        ...
        if (imageUri != null) {
            final StorageReference fileref = storageProfilePictureRef
                    .child(Prevalent.CustMatricIdKey + ".jpg");
